...
export default function MySQLSchema() {
  ...
  const schemaSQL = useMemo(() => `-- SummitCare — MySQL 8.0 schema
-- IMPORTANT:
      ...
      <Card className="mb-4">
        ...
        <CardContent>
          <div className="text-sm text-slate-600 mb-3">
            Tip: run the script in your MySQL client after selecting your target database (USE YOUR_DATABASE_NAME;).
          </div>
