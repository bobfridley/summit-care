...
sudo iptables-save | sudo tee /etc/iptables/rules.v4 > /dev/null`;
  ...
  const testDb = async () => {
    ...
    try {
      ...
      setPingError(_e?.response?.data?.error || _e?.message || 'Error testing DB');
    } finally {
      setPinging(false);
    }
  };
    ...
    <div className='max-w-4xl mx-auto p-6'>
          ...
          {loading ? (
            ...
            <div className='text-gray-700'>
              ...
              <div className='text-sm text-gray-500 mt-1'>
                If your DB requires IP allowlisting, add this IP. Egress IPs may change over time on
                serverless infra.
              </div>
            </div>
          )}
        ...
        <CardContent>
          {pingError ? (
            ...
            <div className='text-gray-500 text-sm'>
              Uses functions/db → action: &quot;ping&quot; to verify connectivity with your current
              environment vars.
            </div>
          )}
      ...
      <Card className='mb-6'>
        ...
        <CardContent>
          ...
          <p className='text-sm text-gray-600 mt-3'>
            Note: If egress IPs change, re-run these commands with the new IP. Keep MySQL bound to
            SSL and use strong passwords.
          </p>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent>
          ...
          <p className='text-sm text-gray-600 mt-3'>
            Tip: For TLS errors with self-signed/hosted CA, set MYSQL_SSL_CA in app settings;
            otherwise temporarily set MYSQL_SSL_MODE=insecure.
          </p>
        </CardContent>
      </Card>
    </div>
