...
import { getMedicationInfo } from "@/api/functions";
...
export default function MedicationForm({ medication, onSubmit, onCancel, onFormChange }) {
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  />
                  {isLoadingInfo && (
                    <Loader2 className="absolute right-3 top-3 w-4 h-4 animate-spin text-primary-blue" />
                  )}
                </div>
            ...
            {drugInfo && (
              <Alert className="border-primary-blue/30 bg-primary-blue/5">
                ...
                <AlertDescription className="space-y-3 mt-2">
                  ...
                  {drugInfo.analysis?.warnings && drugInfo.analysis.warnings.length > 0 && (
                    <div>
                      <p className="text-sm font-medium text-text-primary mb-1">Mountaineering Warnings:</p>
                      <ul className="list-disc list-inside space-y-1 text-sm text-text-secondary">
                        {drugInfo.analysis.warnings.map((warning, idx) => (
