        ...
        <div className='flex justify-between items-start'>
          <div>
            ...
            {medication.generic_name && (
              <p className='text-sm text-text-secondary'>Generic: {medication.generic_name}</p>
            )}
          </div>
          <Badge
            className={`${getRiskColor(medication.risk_level)} border font-medium flex items-center gap-1`}
          >
        ...
        {medication.recommendations && (
          <div className='p-3 bg-primary-green/5 rounded-lg border border-primary-green/10'>
            <p className='text-xs text-text-secondary'>
              <span className='font-medium text-primary-green'>Recommendation:</span>{' '}
              {medication.recommendations}
            </p>
          </div>
        )}
