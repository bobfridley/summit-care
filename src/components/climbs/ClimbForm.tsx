...
type GearCategory =
  | 'safety' | 'clothing' | 'technical' | 'camping'
  | 'navigation' | 'health' | 'food_water' | 'other';
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e: React.ChangeEvent<HTMLInputElement>) => handleChange('mountain_name', e.target.value)}
            ...
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(value: DifficultyLevel) =>
                  handleChange('difficulty_level', value)
                }
              >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-2">
              ...
              <Textarea
                ...
                onChange={(e: React.ChangeEvent<HTMLTextAreaElement>) => handleChange('weather_concerns', e.target.value)}
            ...
            <div className="space-y-2">
              ...
              <Textarea
                ...
                onChange={(e: React.ChangeEvent<HTMLTextAreaElement>) => handleChange('special_equipment', e.target.value)}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e: React.ChangeEvent<HTMLInputElement>) => handleChange('backpack_name', e.target.value)}
