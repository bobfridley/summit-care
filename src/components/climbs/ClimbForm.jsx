...
import GearEditor from "./GearEditor"; // Added import
import PackWeightSummary from "./PackWeightSummary"; // Added import

export default function ClimbForm({ climb, onSubmit, onCancel }) {
  const [formData, setFormData] = useState(climb || {
    ...
    weather_concerns: "",
    special_equipment: "",
    required_gear: [], // Added required_gear to initial state
    backpack_name: "", // Added backpack_name to initial state
    base_pack_weight_kg: "", // Added base_pack_weight_kg to initial state
    status: "planning",
    notes: ""
  });
