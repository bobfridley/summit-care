...
import { ListChecks, Plus, Trash2 } from '@/components/icons';
                ...
                <div className='grid grid-cols-1 md:grid-cols-8 gap-3 md:items-end'>
                  ...
                  <div className='space-y-1'>
                    ...
                    <Input
                      ...
                      onChange={(e: React.ChangeEvent<HTMLInputElement>) =>
                        handleUpdate(idx, 'estimated_weight_kg', Number(e.target.value || 0))
                      }
                      className='border-stone-200'
                  ...
                  <div className='flex items-center gap-4'>
                    ...
                    <div className='flex items-center space-x-2'>
                      <Checkbox
                        ...
                        id={`packed-${idx}`}
                      />
                      <Label htmlFor={`packed-${idx}`} className='text-xs'>
                        Packed
                      </Label>
                    </div>
                  </div>
