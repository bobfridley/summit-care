...
export interface MedicationItem {
  ...
  start_date?: string | null; // ISO or yyyy-mm-dd
  notes?: string | null;
  altitude_risk_level?: AltitudeRisk | null;
}
...
function getRiskColor(level?: AltitudeRisk | null): string {
  switch (level) {
    case 'severe':
...
export default function RecentMedications({ medications, isLoading }: RecentMedicationsProps) {
  return (
              ...
              >
                <div className='flex justify-between items-start mb-3'>
                  ...
                  {medication.altitude_risk_level && (
                    <Badge
                      className={`${getRiskColor(medication.altitude_risk_level)} border font-medium`}
                    >
